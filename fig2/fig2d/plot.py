"""Render Fig. 2d: trifurcating simulated trajectory benchmark."""
...
if __name__ == "__main__":
    ...
    main(
        panel="d",
        topology="trifurcating",
        default_methods=[
            ("GRAVITY", folder / "inputs" / "Pre4temp_dc_stage2.csv"),
        ...
        default_output=folder / "outputs" / "fig2d.png",
    )
